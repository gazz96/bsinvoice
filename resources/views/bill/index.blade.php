...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="mb-3 d-flex justify-content-between align-items-center">
            <h1 class="h2 mb-0 fw-bold">BILLS</h1>

            <div class="d-flex justify-content-end">
                <a class="btn btn-lg btn-primary rounded-pill" href="{{ route('bill.create') }}">
                        ...
                        <tbody>
                            @foreach ($bills as $bill)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        {{ number_format(
                                            $bill->items()->get()->sum(function ($item) {
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item"  href="{{ route('bill.edit', $bill->id) }}">Edit</a></li>
                                                <li><a class="dropdown-item"  href="{{ route('bill.edit', $bill->id) }}">Schedule</a></li>
                                                <li>
                ...
                @else
                    <div class="d-flex justify-content-center py-5 border-top">
                        <div class="text-center">
                            <div class="mb-3">Bill tidak ditemukan</div>
                            <a href="{{ route('bill.create') }}"
                                class="btn btn-lg btn-outline-primary rounded-pill">Buat Bill</a>
                        </div>
                    </div>
                @endif
            </div>
