...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="mb-3 d-flex justify-content-between align-items-center">
            <h1 class="h2 mb-0 fw-bold">HOTELS</h1>

            <div class="d-flex justify-content-end">
                <a class="btn btn-lg btn-primary rounded-pill" href="{{ route('hotel.create') }}">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item"  href="{{ route('hotel.create', [
                                                    'id' => $hotel->id
                                                ]) }}">Edit</a></li>
                                                <li>
                ...
                @else
                    <div class="d-flex justify-content-center py-5 border-top">
                        <div class="text-center">
                            <div class="mb-3">Hotel tidak ditemukan</div>
                            <a href="{{ route('hotel.create') }}"
                                class="btn btn-lg btn-outline-primary rounded-pill">Buat Hotel</a>
                        </div>
                    </div>
                @endif
            </div>
