    ...
    <div class="container-fluid p-0">
        ...
        <div class="card mb-3 border rounded-4">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <h5 class="mb-2 fw-bold">Overdue</h5>
                        <h2 class="text-dark">Rp {{ number_format(\App\Models\Invoice::getTotalPendingPayment()) }}</h2>
                    </div>
                    
                    <div class="col-md-4">
                        <h5 class="mb-2 fw-bold">Due within next 30 days</h5>
                        <h2 class="text-dark">Rp {{ number_format(\App\Models\Invoice::getTotalPendingPayment()) }}</h2>
                    </div>
                    
                    <div class="col-md-4">
                        <h5 class="mb-2 fw-bold">Average time to get paid</h5>
                        <h2 class="text-dark">{{ number_format(\App\Models\Invoice::getTotalPendingPayment()) }} <small class="text-secondary fw-light">days</small></h2>
                    </div>
                </div>
        ...
        <form action="">
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-md-2">
                    <select name="status" id="filter-status" class="form-control form-select form-control-lg rounded-pill"
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        @if ($invoice->status == 'DRAFT')
                                            <a href="{{ route('invoice.approve', $invoice->id) }}" class="fw-bold">Approve</a>
                                        @endif

                                        @if ($invoice->status == 'APPROVED')
                                            <a href="{{ route('invoice.record-payment', $invoice->id) }}" class="fw-bold">Record Payment</a>
                                        @endif
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <!--<li><a class="dropdown-item"  href="{{ route('schedule.manage', $invoice->id) }}">Schedule</a></li>-->
                                                <li>
                                                    <hr class="dropdown-divider">
                                                </li>
                                                <li><a class="dropdown-item" href="{{ route('invoice.preview', $invoice->id) }}">Preview as customer</a></li>
                                                <li>
                                                    <hr class="dropdown-divider">
                                                </li>
                                                <li><a class="dropdown-item" href="#">Export as PDF</a></li>
                                                <li><a class="dropdown-item" href="{{ route('invoice.print', $invoice->id) }}" target="_blank">Print</a></li>
