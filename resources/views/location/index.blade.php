...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="mb-3 d-flex justify-content-between align-items-center">
            <h1 class="h2 mb-0 fw-bold">LOCATIONS</h1>

            <div class="d-flex justify-content-end">
                <a class="btn btn-lg btn-primary rounded-pill" href="{{ route('location.create') }}">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item"  href="{{ route('location.create', [
                                                    'id' => $location->id
                                                ]) }}">Edit</a></li>
                                                <li>
                ...
                @else
                    <div class="d-flex justify-content-center py-5 border-top">
                        <div class="text-center">
                            <div class="mb-3">Location tidak ditemukan</div>
                            <a href="{{ route('location.create') }}"
                                class="btn btn-lg btn-outline-primary rounded-pill">Buat Location</a>
                        </div>
                    </div>
                @endif
            </div>
