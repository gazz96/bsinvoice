                ...
                <div id="menu-wrapper">
                    @forelse($menus as $menu)
                        ...
                        <div class="card border mb-1" style="max-width: 400px;"  data-bs-toggle="collapse" data-bs-target="#menu-{{ $menu->id }}">
                            ...
                            <div class="card border mb-1" style="max-width: 400px; margin-left: 3rem" >
                                <div class="card-header border-bottom" data-bs-toggle="collapse" data-bs-target="#menu-{{ $item->id }}">
